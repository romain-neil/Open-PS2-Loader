...
enum UI_ITEMS {
    ...
    NETCFG_NFS_IP_ADDR_0,
    NETCFG_NFS_IP_ADDR_1,
    NETCFG_NFS_IP_ADDR_2,
    NETCFG_NFS_IP_ADDR_3,
    NETCFG_NFS_IP_ADDR_DOT_0,
    NETCFG_NFS_IP_ADDR_DOT_1,
    NETCFG_NFS_IP_ADDR_DOT_2,
